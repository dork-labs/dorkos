...
| `interactive-tools.md`           | 2026-06-09    | Claude   | Updated QuestionPrompt render/stream refs, onDecided(answers), multi-question UX + QuestionAnswerSummary                                                     |
...
| `data-fetching.md`               | 2026-06-09    | Claude   | Reconciled — updateSession unchanged; per-session settings PATCH adds no new entity hook                                                                     |
