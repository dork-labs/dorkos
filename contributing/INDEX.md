...
| -------------------------------- | ------------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `project-structure.md`           | 2026-06-09    | Claude   | Reconciled — claude-code/ subdir tree already current after the runtime refactor                                                                                 |
...
| `architecture.md`                | 2026-06-09    | Claude   | Removed dropped autoMode field; rebuilt File Organization table + Module Layout tree for claude-code/ subdir refactor; added Subagent Text Streaming section     |
| `design-system.md`               | 2026-03-31    | Claude   | Added Data Tables section (Table/DataTable) and Error Boundaries section                                                                                         |
| `api-reference.md`               | 2026-06-09    | Claude   | Added PATCH /api/sessions/:id (per-session settings; ADR-0260/0261)                                                                                              |
| `configuration.md`               | 2026-06-09    | Claude   | Reconciled — permission modes & per-session settings confirmed out of scope (not in ~/.dork/config.json)                                                         |
| `interactive-tools.md`           | 2026-06-09    | Claude   | Added Recovering Pending Interactions section (hybrid Path A pull + Path B SSE re-emit, idempotency, expiry exclusion, no-cross-restart boundary; ADR-0117/0262) |
...
| `data-fetching.md`               | 2026-06-09    | Claude   | Added pending-interaction recovery (Path B re-emit) note to Session Sync; cross-links interactive-tools + ADR-0117/0262                                          |
