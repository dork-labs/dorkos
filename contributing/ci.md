...
| 7   | `main` is red **now**, read off the newest commit in 28 days so an open spell never ages out of the window and reads as fixed; a spell that already recovered is amber                                                                                                                                                                                       | red                                                |
