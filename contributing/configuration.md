...
| `ui.sidebar`                        | object                                                                   | see below          | Sidebar organization (DOR-329, DOR-339, DOR-525): pinned agents, user-defined groups, per-section sort/collapse/display-filter state, muted agents/groups, and the Channels / Direct-messages collapse flags                                                           |
...
Five `ui.*` backfills have landed. All are append-only and idempotent:
