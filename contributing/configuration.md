...
| `rooms.toolOnlyReplies`                          | boolean                                                                  | `false`              | Whether an agent decides for itself when to speak in a room: it answers with `post_to_room`, reacts, or stays quiet, and its turn text is never posted for it. Experiment (DOR-1613); a session that never got the posting tool keeps posting its text                                                                                                                                                                                                                                                                                                                                                |
...
| `runtimes.dorkosTools`                  | boolean                        | `false`       | Whether codex and opencode agents get the DorkOS tools (rooms, memory, marketplace) over this server's own `/mcp`. Experiment (DOR-1613); claude-code carries them in-process either way                                                                                                                                                                                                                                                                                                                                                                                                                            |
