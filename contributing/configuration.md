...
`0.60.0` is the newest key, carrying a re-run of `backfillRoomsDefaults` for the two collect bounds. It is untagged and it is still closed — merged is what closes a key.
