...
| ------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `__tests__/migration-safety.ts` (DOR-339, DOR-988, DOR-1135)                   | a shipped key's table slice byte for byte, **plus** the normalized source of every declaration in the file it reaches, against the newest release tag | a key authored at or below a released version; any edit — code or comment — to a slice that has shipped; any edit to the BEHAVIOR of a helper or constant a shipped key reaches | anything between merge and tag; prose inside a helper (the slice is byte-compared, the helpers are not); anything outside `config-manager.ts`                       |
