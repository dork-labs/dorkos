...
| BETTER_AUTH_URL          | site   | string (url)        | `http://localhost:3000`          | Public origin of the cloud auth instance. Must be non-localhost in production (verification + OAuth-callback links point at it).                                                                                                                |
