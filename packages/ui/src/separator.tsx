...
function Separator({
  ...
  return (
    <SeparatorPrimitive.Root
      ...
      className={cn(
        'bg-dui-border shrink-0 data-[orientation=horizontal]:h-px data-[orientation=horizontal]:w-full data-[orientation=vertical]:h-full data-[orientation=vertical]:w-px',
        className
      )}
      {...props}
    />
