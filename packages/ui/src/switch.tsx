...
export const switchVariants = tv({
  slots: {
    root: 'peer focus-visible:ring-dui-ring focus-visible:ring-offset-dui-background data-[state=checked]:bg-dui-primary data-[state=unchecked]:bg-dui-input inline-flex shrink-0 cursor-pointer items-center rounded-full border-2 border-transparent shadow-sm transition-colors motion-reduce:transition-none! focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
    thumb:
      'bg-dui-background pointer-events-none block rounded-full shadow-lg ring-0 transition-transform motion-reduce:transition-none!',
  },
