 ...
 * (DOR-1751). The tick still reads statically under reduced motion: the root transition
 * is suppressed locally and the indicator animation is motion-safe only.
 */
