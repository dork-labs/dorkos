...
describe('scanSkills', () => {
  ...
  it('skips a `<pkg>__<skill>` SYMLINK — that is a managed installed projection, not authored', () => {
  ...
  it('finds an authored skill whose source directory is a symlink', () => {
  ...
  it('finds a real directory whose name contains `__` — `__` alone does not mean managed', () => {
...
describe('scanSkillDirs', () => {
  ...
  it('hides a `<pkg>__<skill>` symlink by default and returns it with includeManagedProjections', () => {
  ...
  it('skips a `__` symlink whose target directory has no SKILL.md, either way', () => {
