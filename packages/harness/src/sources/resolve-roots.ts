 ...
 * (marketplace) sources are EPHEMERAL — their on-disk projections are
 ...
 *
 * Installed sources are not flat roots (they carry per-plugin assets) and
 ...
 * committed; installed sources are ephemeral. A skill `dorkos harness adopt`
 * moved is authored, and therefore committed, like any other.
 *
...
/**
 * The `.gitignore` patterns the engine's ephemeral (installed) projections
