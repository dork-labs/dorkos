...
<TypeTable
  type={{
    ...
    'claude-code-runtime.ts': {
      type: 'runtime',
      description:
        'ClaudeCodeRuntime — the default AgentRuntime, encapsulates the Claude Agent SDK',
    },
    ...
    'sessions/transcript-reader.ts': {
      type: 'runtime',
      description:
        'Reads SDK JSONL transcript files — source of truth for Claude Code session data',
    },
