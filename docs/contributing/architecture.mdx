...
Browser, phone web app, and desktop renderer share the local server path. The desktop shell manages a local server.
...
The interface keeps React components independent of network details and supports isolated tests with mock transports.
...
```typescript
// Simplified composition from main.tsx
import { RouterProvider } from '@tanstack/react-router';
import { createAppRouter } from './router';
import { HttpTransport } from '@/layers/shared/lib/transport';
import { queryClient } from '@/layers/shared/lib';
...
- **Shared local client**: the browser, phone web app, and desktop renderer reuse the React app and local server.
