...
> Pulse now counts what needs you and refreshes the moment something happens, Shapes are easier to apply and clean up after themselves, and a brand-new agent visibly wakes up in its first chat.
...
> Pulse turns the right panel into an at-a-glance read on what needs you, the sidebar refocuses on your agents, and a batch of fixes hardens the inspector panel, Docker, and server startup.
...
Older releases (v0.1.0 – v0.45.0) live in the [Changelog archive](/changelog-archive).
