...
- **Direct**: DorkOS connects to a remote tool server using the connection details you configured. Any login needed by its tools stays with that server.
...
<Cards>
  ...
  <Card
    ...
    description="Point DorkOS at a remote tool server with a working connection. DorkOS checks it before adding the account."
  />
  <Card
