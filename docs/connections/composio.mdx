...
Return to **Connections → Accounts**, search for Gmail, Google Drive, Linear, or another service, and select **Connect**. You do not need your own Composio key for this route. The service tile opens a sign-in flow bound to your account. DorkOS uses its server project key and a private account identity derived from your signed-in owner and linked installation. The browser cannot choose another owner, installation, Composio user, or callback.
