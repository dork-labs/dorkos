...
<Callout type="warn">
  DorkOS-managed Composio is configured with production readiness off, and the real account proof
  has not completed. The existing custom Gmail test fixture uses a Google app limited to its owner
  test account. This page describes the shipped behavior, not public availability.
</Callout>
