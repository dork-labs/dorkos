...
A Shape also cannot hand its own timers a free pass. If one asks to run with every approval prompt turned off, DorkOS sets it up asking instead and leaves you a note saying so. You can still raise it yourself on the task, once you have read what it does.
