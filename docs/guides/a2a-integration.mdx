...
For the exhaustive endpoint reference (request/response shapes, error codes), see the internal [API reference §A2A Gateway](https://github.com/anthropics/dork-os/blob/main/contributing/api-reference.md).
