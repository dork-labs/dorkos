...
1. Open the agent, go to **Integrations**, and add an integration like Telegram.
2. Bind the integration and open its **Advanced** settings.
...
<Callout type="info">
  ...
  do, the integration shows a one-line reminder to "message your bot once." After your first
  message, notifications start flowing.
</Callout>
