...
On a phone the table is not offered. Six columns at that width is a scroll bar pretending to be a table, and everything the table says is already on the cards.
