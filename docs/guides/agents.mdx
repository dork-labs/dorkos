...
- **Instructions** and **Boundaries**: the two files you write an agent's behavior into, each with the whole page to itself. Both pages end with a preview of the exact text your agent will be given, so you can read it before you save. See the [Persona Injection](/docs/guides/persona) guide.
