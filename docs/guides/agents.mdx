...
- **Permissions**: what this agent may do on its own, what waits for your yes, and what it cannot do at all — opening and arranging rooms, for a start. A row says "Same as everyone" until you set this agent differently. Only you can change it; the agent cannot change its own. See the [Permissions guide](/docs/guides/permissions).
