...
finish with **Join community**. An invite can grant access to the whole Community or one channel.
...
You can add up to four supported images, PDFs, or text files to one post. Each file can be up to 10 MiB.
...
storage backed up. See the [Community server operations reference](https://github.com/dork-labs/dorkos/blob/main/apps/community/README.md)
for setup, backup, key rotation, and deployment details.
