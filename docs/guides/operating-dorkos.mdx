...
- **Anything you cannot take back waits for you.** Removing an installed package, deleting a scheduled task, removing an agent, and changing an agent's safety boundaries each put a card in front of you. So do installing a package and creating a new one, because both bring new code onto your machine. Nothing lands until you answer. See [Action Approvals](/docs/guides/action-approvals).
