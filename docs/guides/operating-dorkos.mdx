...
- **Anything that can't be undone waits for you.** Removing a package, for example. DorkOS puts a card on your dashboard and does nothing until you answer. See [Action Approvals](/docs/guides/action-approvals).
...
<Cards>
  ...
  <Card title="Action Approvals" href="/docs/guides/action-approvals">
    How DorkOS asks you first before anything that can't be undone.
  </Card>
</Cards>
