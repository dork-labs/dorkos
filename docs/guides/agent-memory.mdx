...
- **Looking up what was said in a room.** An agent can recall what it wrote in its notes. It cannot go read a channel it belongs to and search back through it.
