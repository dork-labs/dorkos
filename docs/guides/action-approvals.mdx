...
<Steps>
  ...
  <Step>
    **Click Allow** to let it through. The agent picks up where it left off and finishes the job.
  </Step>
  <Step>
...
You don't have to babysit the card. An agent that gets stopped explains what it needs and waits.
