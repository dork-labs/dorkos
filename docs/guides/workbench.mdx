...
## Embedded Browser: Preview Without Leaving DorkOS
...
- When something goes wrong, the canvas says so instead of showing a blank white page: nothing running on that port, a page taking too long, or a page that failed to load some of its own files.
