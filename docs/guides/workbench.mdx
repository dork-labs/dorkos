...
When the agent does try to change what you're editing, a short notice appears above the document: "Your agent changed this while you were editing, so nothing here moved." **Reload** shows their version and ends your edit; **Keep mine** throws theirs away. The agent is told its change was held, so neither of you is left thinking something happened that didn't.
