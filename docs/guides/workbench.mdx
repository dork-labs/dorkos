...
In the permission mode DorkOS ships with, your agent does this without stopping to ask. If you've set a mode that asks first, you'll see a card the first time it clicks something, the same as for any other action. Everything it does happens inside the sandboxed preview frame DorkOS serves: that frame has no sign-in of yours, no reach into DorkOS itself, and no path to the rest of your machine.
