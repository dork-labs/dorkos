...
<Callout type="info">
  Persona text is appended to Claude Code's existing system prompt. You don't need to repeat general
  coding instructions — focus on what makes this agent unique.
</Callout>
