...
Every run looks at which agents your project actually uses. If it finds one you have not turned on — a `.cursor/` folder appeared last week, say — it tells you, and tells you how to turn it on:
