...
description: One place for every AI agent you run. Claude Code, Codex, and OpenCode, all in one app.
---
...
DorkOS is one place for every AI agent you run: Claude Code, Codex, and OpenCode. Your agents work here, report back here, and you keep an eye on every project from the same window. One of you starts to feel like a whole team. That is the point.
...
<ProductShot
  id="cockpit"
  alt="The DorkOS app: a session list on the left, an active agent chat in the middle, and the workbench panel on the right"
/>
...
<Cards>
  ...
  <Card title="Scheduled tasks" href="/docs/guides/task-scheduler">
    Put agents on a schedule. They work without you at the keyboard.
  </Card>
  ...
  <Card title="Tool Approval" href="/docs/guides/tool-approval">
    Choose when a session stops to ask you before it acts.
  </Card>
...
<Cards>
  <Card title="Architecture" href="/docs/concepts/architecture">
    How the app, the server, and your agents fit together.
  </Card>
