...
- **A second window**: press `Cmd/Ctrl+K`, pick an agent, and choose **Open in New Window** to park it on another screen. **Open Here** and **Open in New Tab** are on the same menu.
