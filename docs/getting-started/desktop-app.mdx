...
- **A native menu**: About DorkOS, Check for Updates, and Settings (`Cmd/Ctrl+,`), plus a Help menu with links to the docs and to report an issue. (On Windows the menu works, but it's still shaped like a Mac menu; a proper Windows layout is on the roadmap.)
