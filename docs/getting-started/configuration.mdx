...
<TypeTable
  type={{
    ...
    'profile.displayNameSource': {
      description:
        'Who chose the name above: you, or an agent that suggested it. Set automatically; you never edit it. When an agent picked the name, your team page and account menu say "Suggested by DorkBot" until you save a name yourself. Local-only; never included in any telemetry payload.',
      type: 'object | null',
      default: 'null',
    },
