...
Choosing `autonomy` is the one that asks you first. DorkOS will not save it until you have read what Full autonomy means and confirmed it, and it writes down that you did — after that, every new chat starts without asking and without stopping to check with you again. Settings shows a quiet note while that is on, so you can always find it. Chats you already have keep what they are running with, whatever you change here. This setting is for the chats you open yourself: scheduled runs, integrations, and rooms have their own settings and their own, stricter rules.
...
Turning a conversation up to Full autonomy asks you to confirm what that means first. The agent stops asking about anything, so it is a setting you cannot notice in time to undo — which is why it asks twice.
