...
<TypeTable
  type={{
    'harness.autoSync': {
      description:
        'Keep your coding tools in sync automatically: after a marketplace plugin is installed or uninstalled, and whenever a skill is added or removed while DorkOS is running. Set to false to manage projection manually via `dorkos harness sync`.',
      type: 'boolean',
      default: 'true',
    },
