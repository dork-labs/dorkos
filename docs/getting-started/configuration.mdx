...
<TypeTable
  type={{
    'ui.autonomyAcknowledgedAt': {
      description:
        'When you read what Full autonomy means and asked not to be shown it again. DorkOS writes this itself when you tick the box; Reset in Settings clears it back to null.',
      type: 'string | null',
      default: 'null',
    },
  }}
