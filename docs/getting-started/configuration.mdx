...
Some features work but have not been lived with long enough to be the default. Those wait in **Settings → Experiments**, off until you turn them on, each one saying plainly what it gives you and what it costs.
