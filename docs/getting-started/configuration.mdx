...
Some packages ship hooks: commands your coding agent runs on its own, before or after it does things. Those never get installed quietly. DorkOS shows you the exact commands and waits for you to say yes, and it remembers your answer per package and per project. If a later version of the package wants to run something different, it asks again.
