...
**In the [desktop app](/docs/getting-started/desktop-app) this fixes itself.** The app wants 4242, and takes the next free port (4243, then 4244) when it can't have it. Open **Settings → Server** to see the address it landed on and copy it. Only when ten ports in a row are busy does it stop and tell you, and the message names the range so you know what to free up.
