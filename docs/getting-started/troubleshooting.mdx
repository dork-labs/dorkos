...
## "Restart DorkOS and Reset all data don't work in the desktop app"

Both buttons in **Settings → Danger zone** now refuse in the desktop app, and say why. The app starts and stops the server itself, so a restart triggered from inside would leave you with no server running at all.
