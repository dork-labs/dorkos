---
title: Installation
description: Install DorkOS via one-liner, npm, Docker, Obsidian plugin, or self-hosted
---
...
Checks for Node.js 22+, installs DorkOS via npm, and optionally runs the setup wizard.
...
<Callout type="warn">
  The Obsidian plugin requires Node.js 22+ installed on your system. It runs the same Claude Agent
