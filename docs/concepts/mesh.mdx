...
Mesh watches each agent through a heartbeat: a quick "still here" signal an agent sends as it works. From that, it sorts every agent into one of three states:
