...
- **claude-code** — Detects projects with a `AGENTS.md` file at the project root (the Claude Code convention). Extracts a description from the first paragraph of `AGENTS.md`.
