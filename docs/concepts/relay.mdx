...
Relay connects to external platforms through **adapters**: plugins that bridge external connections into the Relay subject hierarchy. DorkOS ships with four built-in adapters:
