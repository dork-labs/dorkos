...
<Callout type="info">
  Want a picture of this? A short clip of a session appearing in the DorkOS sidebar the instant
  you start it from the CLI says more than the paragraph above ever could.
</Callout>
