...
- Your Nango **secret key**: open **Connections** in the sidebar, scroll to **Providers**, paste it
...
connector is on. When any of them is missing, DorkOS leaves it off and the Providers card says what
