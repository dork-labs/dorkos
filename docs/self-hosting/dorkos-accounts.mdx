...
If you prefer the UI, open **Settings → Access** in the DorkOS client and find the **DorkOS account** section (visible whether or not local login is on):
...
<ProductShot
  id="accounts-pending"
  alt="Settings → Access, DorkOS account section, showing the 8-character link code and the 'Open dorkos.ai/activate' button, waiting for approval"
/>
...
<ProductShot
  id="accounts-linked"
  alt="The same Settings panel flipped to Linked — a green dot, the linked account, and 'Last synced just now'"
/>
