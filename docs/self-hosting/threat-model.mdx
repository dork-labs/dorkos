...
- **Reaching a human is a consent choice.** Whether an agent may start a conversation with you on a connection like Telegram is a per-connection setting you control.
