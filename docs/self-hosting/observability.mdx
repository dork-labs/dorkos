...
- `dorkos.gen_ai.thinking_tokens`: how many of those output tokens the model spent thinking, when the runtime reports it. It is part of the output count, not an extra on top, so adding the two counts the same tokens twice.
