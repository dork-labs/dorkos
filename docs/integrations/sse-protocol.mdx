...
<TypeTable
  type={{
    ...
    turn_end: {
      type: "{ terminalReason?: 'completed' | 'aborted_streaming' | ... }",
...
<TypeTable
  type={{
    ...
    interaction_resolved: {
      ...
      description:
        'A pending interaction was resolved — by an operator on any client, or without one (timeout, superseding steer). Remove the prompt card.',
    },
  }}
/>
