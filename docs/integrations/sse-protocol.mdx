...
| `config_changed`                | `{ sections: string[], changedAt: string }`                                                                                 | Settings were written. Section names only, never a value. Sent for every write, including one that stored the same value. Addressed — see below                                                                            |
