...
# 0185. Two-Layer DorkOS Knowledge Architecture (System Prompt + AGENTS.md)
...
- DorkBot's AGENTS.md content may drift from the injected system prompt content
