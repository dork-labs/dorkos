...
- For a registered account it persists the record as `<dork-home>/runtimes/claude-code/usage/<id>.json`, the same file flow writes, in the shared contract's shape.
