...
- A link to an agent's profile opens it even when you are in a different agent's session, and no longer keeps other agents' panels open behind it, and no longer wipes a page you were reading when something else changes the address (DOR-1254)
