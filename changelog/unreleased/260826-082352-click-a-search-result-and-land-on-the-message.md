...
- Pick a result that was said inside a thread and the thread opens beside the conversation with that reply on screen, rather than leaving you on the collapsed "3 replies" line (DOR-687)
