...
- Faces, names, and cards now answer when you point at them. A card on the Team page lifts a little and picks up a hint of that agent's own color. An avatar you can click rings itself in its color. A mention in a room brightens by one step. Before this, most of these just sat there, and you found out something was clickable by clicking it.
...
- You can reach all of it with a keyboard. Anything that responds to the mouse now responds to Tab the same way, including the agent chip above the chat box, which had no keyboard highlight at all.
...
- A profile panel now carries a thin line in that person or agent's own color, so you can tell whose panel you have open at a glance.
