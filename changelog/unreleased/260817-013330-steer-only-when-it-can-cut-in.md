...
covers:
  ...
  - 'fix(test-utils,client,server): make the steer conformance case discriminate, and the Steer gate provable in the DOM'
---
...
- If a message can't cut in after all, the chat says so — "Couldn't cut in. It's waiting in line." — instead of staying silent
