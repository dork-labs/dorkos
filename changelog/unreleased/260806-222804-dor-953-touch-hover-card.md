---
covers:
  - 'fix(client): open identity hover cards on touch (DOR-953)'
  - 'fix(client): give the touch identity-card gesture priority over the message drawer (DOR-953)'
  - 'fix(client): claim gesture priority without severing native pointer events (DOR-953)'
---
