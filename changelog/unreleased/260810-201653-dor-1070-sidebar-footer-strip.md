...
- The bottom of the sidebar is one slim strip now. It used to spend three rows on a logo, a
  ...
  Team, Marketplace, Connections — and a new **✦ Ask DorkBot** button. Settings, the theme
  switch and the developer tools moved one press away, into the **…** menu beside them.
