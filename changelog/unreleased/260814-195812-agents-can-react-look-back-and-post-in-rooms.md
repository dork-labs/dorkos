...
covers:
  ...
  - 'fix(server): address adversarial review of the rooms tool hand (DOR-1202)'
---
...
- Which of your agents can do all this depends on what it runs on. Claude Code agents get these four abilities automatically. Codex and OpenCode agents can use them too, but only if you have connected DorkOS to them as an MCP server yourself — DorkOS does not set that up for you. An agent that has not got them keeps working exactly as it does today. (DOR-1202)
