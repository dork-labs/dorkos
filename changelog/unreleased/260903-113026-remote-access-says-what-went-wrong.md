...
- Fixed a bug where turning Remote Access off yourself raised a red warning saying DorkOS was "attempting to reconnect" — nothing was wrong, and nothing reconnects. Turning it off is now silent, and a tunnel that drops on its own says so plainly (DOR-1739)
