...
- Mute a noisy agent or an entire group from its right-click menu. A muted agent dims, drops its activity badge, and never lights up a group's rollup dot, but it always stays in place and clickable. Unmuting a group restores each member's own mute setting. (DOR-339)
