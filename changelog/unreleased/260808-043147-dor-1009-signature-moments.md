---
covers:
  - 'feat(client): the four signature moments on top of the identity grammar'
---
...
- Point at an agent's face and its little robot mark leans in. Only on faces you can actually do something with, so the long list of agents in the sidebar stays still.
