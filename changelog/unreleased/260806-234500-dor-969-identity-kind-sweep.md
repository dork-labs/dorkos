...
- The avatar next to an approval request now looks like an agent too, not a plain circle. (DOR-969)

### Added

- Hover over an agent's name and you can now see who it belongs to: a "Managed by @handle" chip, or the owner's name if they don't have a handle yet. (DOR-969)
