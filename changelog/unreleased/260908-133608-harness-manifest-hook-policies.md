...
- Allowing a package's hooks no longer records an answer that quietly comes true later. `dorkos harness sync --fix --allow-hooks <package>` stops and explains itself when your manifest says none of your agents should get those hooks — because saying yes was being saved, and would have installed them the day you changed that line, without asking. When only some agents are covered it saves your answer and tells you which ones miss out.
