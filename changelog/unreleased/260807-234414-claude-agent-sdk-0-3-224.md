...
- Stopping a turn now stops it properly. A tool that was waiting on a permission check could still run after you pressed stop. (DOR-1014)
- Sessions that run for hours no longer leak a little memory on every turn. (DOR-1014)
