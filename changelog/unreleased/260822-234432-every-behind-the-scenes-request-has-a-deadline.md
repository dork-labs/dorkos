...
- Reloading plugins after installing something from the Marketplace now finishes instead of waiting forever on an agent that has already stopped listening (DOR-1301)
