...
**Six paths in the repo spend real money, and each needs its OWN flag beside its OWN key.** The shape is always the same — the flag is the decision, the key is the instrument, and a key alone arms nothing, because plenty of people leave one exported and having a key is not the same as deciding to spend.
