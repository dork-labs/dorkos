...
![The DorkOS app with the agent fleet and recent activity](/product/archive/v0.54.0/cockpit-light.png)
...
- Three interface papercuts, one per surface: real Marketplace names (with a matching A–Z sort), Cmd+. and Cmd+Shift+A handed back to Obsidian, and the arrival card's emoji face.
