...
![A DorkOS chat reply rendering a fleet-status widget with stats, a bar chart, a timeline, and action buttons](https://dorkos.ai/product/archive/v0.45.0/gen-ui-widgets-light.png)
...
![A DorkOS canvas document open beside the chat, rendering live beside a streaming session](https://dorkos.ai/product/archive/v0.45.0/canvas-dark.png)
