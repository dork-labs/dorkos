---
title: DorkOS 0.45.0
description: Agents can now show their work as interactive widgets, the right panel becomes a real workbench, and Codex and OpenCode join Claude Code in one place
date: 2026-07-09
author: DorkOS Team
category: release
...
DorkOS 0.45.0 is our biggest release yet. Agents can now answer with real, clickable widgets instead of walls of text. The right panel grew into a full workbench with a terminal, file explorer, and browser. And DorkOS now runs Codex and OpenCode agents next to Claude Code, all in one window.
...
**One place for Claude Code, Codex, and OpenCode**
...
- Run Codex and OpenCode agents next to Claude Code, all in one place. Every session shows which runtime it belongs to, and the session list keeps working even when one runtime is down.
...
- Run a real shell right in the app: open a Terminal tab in your session's working directory without leaving DorkOS (web only).
