---
title: DorkOS 0.19.0
description: Fleet management dashboard — dedicated agents page, a live overview, and client-side routing
date: 2026-03-21
author: DorkOS Team
category: release
...
Fleet management graduates from a dialog tab to a first-class page, and the dashboard becomes a true control surface with real-time system awareness.
...
**Dashboard Content** — The dashboard now surfaces what matters: needs-attention alerts, active sessions with live status, system health sparklines for Pulse/Relay/Mesh, and a time-grouped activity feed. One screen for autonomous operations.
...
- Access an at-a-glance dashboard with needs-attention alerts, active sessions, system status, and activity feed
