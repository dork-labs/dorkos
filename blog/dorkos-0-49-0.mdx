...
You no longer have to install DorkOS to see what it does. Run `npx dorkos@latest` and it downloads DorkOS, starts it, and opens DorkOS in your browser. The first run takes a minute or two while it sets up; a regular install skips that wait next time.
...
- Try DorkOS without installing anything: `npx dorkos@latest` downloads it, starts it, and opens DorkOS in your browser. The first run takes a minute or two; a regular install skips that wait next time.
