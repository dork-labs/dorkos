...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ERR_PNPM_LOCKFILE_CONFIG_MISMATCH` on **every** job                                                                                                                          | Dependabot regenerated the lockfile without the `overrides:` block (DOR-1644)                                                                | `dependabot-lockfile-repair.yml` pushes the fix; if its commit is absent the workflow failed — check `MERGE_TAIL_TOKEN`. On a takeover branch a plain `pnpm install` repairs it. |
