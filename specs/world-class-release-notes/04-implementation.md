...
- `plans/archive/2026-02-18-automatic-adr-extraction-design.md` — Fixed missing frontmatter (pre-existing issue)
...
- Pre-existing: `plans/archive/2026-02-18-automatic-adr-extraction-design.md` had no frontmatter `title` — fixed as part of build verification
