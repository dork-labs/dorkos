...
- [ ] **1.1 Add explicit tenant keys and host operators.** Expand the schema without removing current safety constraints.
- [ ] **1.2 Backfill and validate zero- or one-community databases.** Keep fresh installs bootstrap-ready, preserve every populated identity, and refuse ambiguous data.
