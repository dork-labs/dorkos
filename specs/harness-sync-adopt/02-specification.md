...
The blast radius is **five code references and seven doc comments**, measured — not the four an
earlier draft counted:
...
27. **409** with no manifest; **400** for a relative `projectPath` — from the route module's own
