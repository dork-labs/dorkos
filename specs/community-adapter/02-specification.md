...
| **C15** | `signals`                                                  | `'both'`: publish → receive on a second subscription                                                                                                                                                                                                                                                                          | `'none'`: publish rejects and no signal is ever yielded. There is no third branch — OQ8 cut `'receive'`. **[Amended 2026-07-29 (room-presence): the `'both'` branch also round-trips the presence payload — see Amendment 2.]** |
