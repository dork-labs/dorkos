...
| 4   | Stage↔state mapping      | _*Coarse PM states + `stage/`* labels; match on state *category\**_                                                                                                                                                                                         | Clean 1:1 at the trigger level; PM-agnostic; no brittle per-team state config.                                                                                                                                                                                                                         |
