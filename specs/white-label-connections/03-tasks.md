...
| Workstream | Tracker                                                                                                                        | Deliverable                                                                                                    | Depends on          | Can overlap with |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------- | ------------------- | ---------------- |
| 1.1        | [DOR-1793](https://linear.app/dorkspace/issue/DOR-1793/white-label-connections-p1-stable-provider-instance-connection-grant)   | Stable identities, immutable operation revisions, typed reviews, durable event inbox, and ledgered migration   | —                   | —                |
| 2.1        | [DOR-1794](https://linear.app/dorkspace/issue/DOR-1794/white-label-connections-p2-enforced-connector-execution-across-dorkos)  | One enforced execution and usage path for DorkOS MCP, REST, and scoped CLI                                     | 1.1                 | —                |
| 3.1        | [DOR-1795](https://linear.app/dorkspace/issue/DOR-1795/white-label-connections-p3-complete-connections-management-access)      | Complete local management, Transport, CLI review handoff, access presets, usage, and responsive Connections UX | 1.1, 2.1            | 4.1              |
| 4.1        | [DOR-1796](https://linear.app/dorkspace/issue/DOR-1796/white-label-connections-p4-tenant-scoped-managed-connector-service-in)  | Tenant-scoped managed connector routes and data in `apps/site`, including verified single-use account linking  | 2.1                 | 3.1              |
| 5.1        | [DOR-1797](https://linear.app/dorkspace/issue/DOR-1797/white-label-connections-p5-signed-managed-and-byo-event-ingress-with)   | Signed hosted/local ingress, protected restart-safe inboxes, receipts, and one durable routing worker          | 2.1, 4.1            | 6.1              |
| 6.1        | [DOR-740](https://linear.app/dorkspace/issue/DOR-740/white-label-connections-p6-respec-dor-740-for-private-agent-requests)     | DOR-740 respec: private agent request, operator auth/grant, live hold, and restart-safe resume                 | 2.1, 3.1, 4.1       | 5.1              |
| 7.1        | [DOR-1798](https://linear.app/dorkspace/issue/DOR-1798/white-label-connections-p7-remove-legacy-paths-verify-all-surfaces-and) | Legacy removal, full integration evidence, docs, and per-capability production provisioning gate               | 1.1–6.1 and DOR-738 | —                |
...
- **DOR-738** remains a separate prerequisite fixing raw-MCP false authentication success. Workstream 7 consumes its verified result and does not reproduce the fix.
- **DOR-740** is workstream 6. Its existing Connections naming, tool guidance, session group, “Ask your agent,” and entry-point scope is retained where useful, while its raw agent start-connect instruction is replaced by operator-owned authentication and grant resolution.
