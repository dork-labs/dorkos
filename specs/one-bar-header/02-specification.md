...
| -------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/`                                                                                    | `BarTabStrip` (home surfaces), Home active                                                    | `#team` members chip (opens room right panel); system-health dot anchored right of the flex space, after any page action (same x on all four home surfaces). Working chip + halt arrive with R1's room chips — H1 ships without them on Home, where the live lane's stop-all above the composer is the reach that survives | —                                                                                                                                                                                               |
