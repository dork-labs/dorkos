...
**Research Depth:** Deep (15+ searches, 6 page fetches)
**Purpose:** Evaluate world-class frameworks for mapping product features to customer benefits and value

---

## Research Summary

This report documents ten canonical frameworks plus modern extensions used by elite marketers to bridge the gap between what a product is and why it matters. The frameworks span direct-sales methodology (FAB), academic consumer psychology (Means-End Chain), strategic positioning (Dunford, Moore), narrative branding (StoryBrand, Nike), enterprise communications architecture (Message House), and customer research methodology (JTBD). Each framework operates at a different altitude — from tactical copywriting to strategic identity — and the strongest marketing operations layer multiple frameworks together.
...
```
FEATURE    →   What the product IS / has (objective, verifiable)
ADVANTAGE  →   Why the feature matters compared to alternatives (relative, comparative)
BENEFIT    →   What the customer GETS / feels / achieves (subjective, emotional)
```
...
- Can produce generic benefits if not grounded in deep customer research
...
The Means-End Chain maps product attributes to personal values through three hierarchical levels:
...
4. Code responses into Attributes → Consequences → Values categories
5. Aggregate across respondents into an **Implication Matrix**
...
- Instrumental value: Being responsible
...
- Terminal values are stable across many product categories, reducing differentiation (every product ladders to "security" or "accomplishment")
...
Customer Pains (frustrations, risks, obstacles)
    ↓
Customer Gains (desired outcomes, expectations, aspirations)
```
...
Products & Services
    ↓
Pain Relievers (how the offering addresses specific pains)
    ↓
Gain Creators (how the offering produces specific gains)
```
...
- The most widely adopted framework in the startup/innovation world
...
- Jobs can be defined at the wrong altitude (too broad: "be productive"; too narrow: "export to CSV")
- Social and emotional jobs are frequently under-developed compared to functional jobs
...
Dunford's framework is defined by five interdependent components that must be resolved in sequence:

```
1. COMPETITIVE ALTERNATIVES
   What would customers do if your product didn't exist?
   (spreadsheets, manual processes, doing nothing, competitor X)
         ↓
2. UNIQUE ATTRIBUTES
   What do you have that the alternatives don't?
   (features, capabilities, approach, data, IP, integrations)
         ↓
3. VALUE (The "So What?")
   Why do those unique attributes matter?
   What meaningful outcome do they enable?
         ↓
4. TARGET CUSTOMER SEGMENTATION
   Which customers care most about this specific value?
   Who feels the pain most acutely?
         ↓
5. MARKET CATEGORY
   What context/frame makes this value immediately obvious?
   (existing category, resegmented category, new category)
```

**The Critical Insight — Features Are Only Differentiated in Context:**
...
- Highly practical for B2B SaaS, where the decision to buy is mediated by category framing
...
- Doesn't produce copy or creative direction directly — it produces a positioning statement that must be translated
...
- Target customer: Developers who've been burned by Firebase's pricing/lock-in
- Market category: Backend-as-a-Service (anchored against Firebase, the market leader)
...
CHARACTER (The Hero = Customer)
  ...
  Define the single desire relevant to your brand's offering.
         ↓
PROBLEM
  VILLAIN (the antagonist force creating the problem)
  EXTERNAL problem (surface-level, what they search for)
  INTERNAL problem (how the villain makes them feel)
  PHILOSOPHICAL problem (why it's fundamentally wrong)
         ↓
GUIDE (Your Brand)
  EMPATHY (we understand your struggle)
  AUTHORITY (we've solved this before)
         ↓
PLAN
  3-step process that makes the path feel safe
  (reduces customer anxiety about committing)
         ↓
CALL TO ACTION
  DIRECT CTA (buy/start/schedule)
  TRANSITIONAL CTA (free resource, lead magnet)
         ↓
FAILURE
  What happens if they don't act?
  (show the stakes without fear-mongering)
         ↓
SUCCESS
  The transformed life after using your product
  (aspirational vision of what their life looks like)
```

**The Central Principle:**
"Your brand is not the hero. Your customer is the hero. Your brand is the guide." This is a deliberate inversion of how most companies communicate — they position themselves as the hero of their own story, which doesn't engage customers emotionally.

**BrandScript Implementation:**
The SB7 framework is operationalized through a one-page BrandScript that becomes the source document for website copy, email sequences, sales scripts, and social content. Miller teaches that all brand communication should filter through this narrative structure.

**The One-Liner (Elevator Pitch Formula):**
"We help [IDENTITY] do [PROBLEM] so they can [RESULT]."
...
- Widely adopted, with extensive templates, workshops, and certified practitioners
...
- Oversimplifies the problem layer — real buyer psychology is more complex than three nested problem types
- Does not distinguish between features and benefits — leaves that work to the user
...
```
ROOF — Primary Message (The Headline)
  One sentence capturing the core value and promise.
  Must be defensible, differentiated, and memorable.
  ───────────────────────────────────────────────────
PILLAR 1          PILLAR 2          PILLAR 3
Supporting theme  Supporting theme  Supporting theme
(3-4 pillars max, each a distinct value dimension)
  │                   │                   │
PROOF POINTS     PROOF POINTS     PROOF POINTS
  - Data/stat      - Case study     - Expert quote
  - Example        - Testimonial    - Benchmark
  - Demo           - Certification  - Third-party
```
...
- Executive communications (keynotes, earnings calls)
- Partner/channel communications
...
- Pillar 3: "Build and automate on the world's most trusted platform" (Platform)
...
- Easy for legal/compliance review (claims are enumerated and attributed)
...
- Does not address customer psychology — it is entirely supply-side (what we want to say)
...
```
BRAND ESSENCE / SOUL (optional apex)
  The irreducible spirit of the brand in 2-3 words.
  (Nike: "Authentic Athletic Performance")
         ↑
SELF-EXPRESSIVE BENEFIT
  What using this brand says about me to myself and others.
  Identity signal, tribal membership, values alignment.
  ("I am a serious athlete / I make considered choices")
         ↑
EMOTIONAL BENEFIT
  How the functional outcome makes me feel.
  A specific, ownable emotion — not generic.
  ("I feel confident / capable / liberated / respected")
         ↑
FUNCTIONAL BENEFIT
  The practical, measurable result of using the product.
  What it literally does for me.
  ("I get more done in less time")
         ↑
PRODUCT ATTRIBUTE / FEATURE
  The physical or functional characteristic.
  Verifiable, often spec-level.
...
4. Determine the self-expressive benefit that emotional benefit contributes to
5. Find the intersection of emotional and self-expressive benefits that is: (a) true to the product, (b) relevant to the target, (c) ownable versus competitors
6. That intersection = the brand's positioning territory
7. "Brand Essence" is derived from the intersection of all ladder tops

**Differentiation from FAB:**
...
- The ladder assumes a single, coherent brand position — breaks down for platform or multi-product brands
...
- Self-expressive: "I pursue excellence / I push limits / I take care of my body"
...
- Self-expressive: "I am creative / I have taste / I think differently"
- Brand Essence: Creative power, beautifully realized
...
**JTBD Core Concept:**
Customers don't buy products — they "hire" products to make progress in specific circumstances. The job is the unit of analysis, not the product or the customer.

```
JOB STATEMENT FORMAT:
"When [situation], I want to [motivation / job], so I can [desired outcome]."

Example: "When I'm running a standup and need to know what's blocking the team,
         I want to see all in-progress work in one view,
         so I can unblock my team and keep us on pace."
```
...
4. CONFIRM   → Validate readiness to execute
5. EXECUTE   → Execute the core task
6. MONITOR   → Monitor execution quality
7. MODIFY    → Make adjustments in real-time
8. CONCLUDE  → Finish the job and transition to next steps
```

**Desired Outcome Statements (ODI):**
Format: "Minimize/maximize the [metric] when [doing the job step]."
...
- Does not directly produce positioning or copy — produces a research foundation that must be interpreted by a strategist
...
- **Zero product mention**: The campaign ran for three years and never showed a product — it built the identity platform that product campaigns would later leverage

### Era 2: Product Marketing (2001-present) — Benefit-First, Context-Built

**The Methodology (as practiced):**

```
STEP 1: DEFINE THE BENEFIT FIRST
  "What is the singular experience this product enables?"
  Do this before naming the product.
  Jobs defined "1,000 songs in your pocket" months before the iPod was named.

STEP 2: FIND THE HUMAN TRUTH
  What frustration / limitation / inadequacy does this product eliminate?
  "Choosing which songs to bring" → "Carry your whole library"

STEP 3: TRANSLATE SPECS TO OUTCOMES
  Never lead with specs. Translate every technical attribute to a human outcome.
  "5GB storage" → "1,000 songs in your pocket"
  "48MP sensor with photonic engine" → "Photos that look like your memories"
  "M4 chip with 40 TOPS neural engine" → "The fastest Mac ever built"

STEP 4: CONTROL THE CATEGORY LANGUAGE
  Apple invents or redefines the vocabulary for their product category.
  "MP3 player" → "digital music player"
  "Tablet computer" → "magical and revolutionary" → "iPad"
  "Smartphone" → "the internet in your pocket"

STEP 5: LAUNCH AS A CULTURAL EVENT
  The launch itself is messaging. The keynote is a narrative arc.
  Product demos are benefit demonstrations, not feature showcases.
  "Here's one more thing" creates anticipation architecture.

STEP 6: ACHIEVE CREATIVE INTEGRATION
  Advertising, packaging, retail, UX, and product language form one narrative.
  White earbuds, white packaging, white retail = consistent message about simplicity and purity.
```
...
4. **Simplicity as philosophy**: One product, one key message, one visual per campaign
...
```
LAYER 1 — BRAND PLATFORM (The Transcendent Layer)
  "Just Do It" + Mission: "To bring inspiration and innovation
  to every athlete in the world (if you have a body, you are an athlete)"
  This layer operates above any specific product or sport.
  It is about human potential, not Nike products.
         ↓
LAYER 2 — SPORT/CATEGORY IDENTITY
  Basketball: Jordan Brand ("Become Legendary")
  Running: Nike Run Club ("Run Your World")
  Training: Nike Training Club
  Each sport category has its own emotional territory
  that connects to the master brand.
         ↓
LAYER 3 — PRODUCT MARKETING
  Specific product features translated to performance benefits.
  "Air Max cushioning" → "Every step feels like the first"
  "Flyknit technology" → "Like a second skin"
  Product marketing inherits emotional equity from layers above.
```

**The Origin of "Just Do It" (1988):**
Dan Wieden (Wieden+Kennedy) coined "Just Do It" from an unlikely source — the last words of convicted murderer Gary Gilmore before his execution. Wieden transformed this into a universal call to action that could speak to both competitive Olympic athletes and people taking their first morning walk. The genius: **the slogan is about the customer's action, not Nike's product**.
...
The intersection of these three circles became the creative territory for "Just Do It."

**Nike's Athlete Partnership Architecture:**
Nike doesn't just use athletes in ads — athletes are brand co-authors. Michael Jordan didn't endorse Nike; Jordan Brand is a co-created sub-architecture that generates its own meaning. LeBron, Serena, Tiger — each generates cultural meaning that feeds back into the master brand.

**The "Democracy of Athletes" Move:**
...
```
PRODUCT     = Backend logic (what the product actually does)
POSITIONING = API (what is it, who's it for, what does it replace, how's it different)
MESSAGING   = Component library (reusable narrative pieces across channels)
COPY        = UI/Frontend (what users actually read and respond to)
```
...
**Anchoring Strategy for Dev Tools:**
...
The "Unlike... We..." format is increasingly used for AI product positioning:
...
4. **DLG (Developer-Led Growth)**: "Build before you buy" — developers evaluate products through hands-on integration, so messaging must serve technical evaluation, not just executive persuasion
...
Example: "Sub-100ms response time" → "No loading spinners during your standup" → "We build software that respects your time and attention"
...
Example: "Zero-configuration deployment" → "Push to GitHub, ship to the world" → "Move at the speed your ideas deserve"
...
- **Suitability for developer tools**: How well does the framework address the specific purchase dynamics of technical audiences?
- **S-tier marketing output**: When executed by a top practitioner, how close does it get to exceptional, category-defining marketing?

---

## Strategic Synthesis: How to Layer These Frameworks

World-class marketing organizations don't use one framework — they use a layered system:

```
RESEARCH LAYER (Insight Generation)
  ├── JTBD Switch Interviews → understand purchase motivation + competition
  ├── Means-End Chain Laddering → understand emotional + values territory
  └── VPC Customer Profile → map jobs, pains, gains exhaustively

STRATEGY LAYER (Positioning & Architecture)
  ├── Dunford Framework → competitive positioning + market category
  ├── Brand Ladder → emotional + identity territory
  └── Message House → organize claims hierarchically

EXECUTION LAYER (Messaging & Copy)
  ├── Apple Methodology → benefit-first translation, category language
  ├── StoryBrand BrandScript → website + sales copy architecture
  └── FAB → feature copy for product pages, tooltips, email

BRAND LAYER (Long-term Identity)
  ├── Nike Architecture → platform + sub-brand + product layers
  └── Think Different model → values-first brand platform
```
...
4. **Brand Ladder** to identify the emotional + identity territory to own
5. **FAB / Apple Methodology** for feature → benefit copy translation
6. **Message House** for channel + team alignment

---

## Research Gaps & Limitations

- **Primary sources for FAB origin**: The exact creator/first publication could not be verified — the framework is attributed to the direct sales tradition without a single named originator
- **Nike's internal brand brief**: Jerome Conlon's full strategic brief is referenced but not publicly available in full
- **Linear's internal messaging docs**: Linear's positioning is inferred from public communications; internal frameworks were not accessible
- **Newer AI-era frameworks**: The AI Competitive Positioning Matrix and Developer Positioning Stack are observed patterns, not formally published frameworks — they lack the theoretical rigor of Gutman or Ulwick
- **Empirical comparison data**: Head-to-head studies comparing framework effectiveness (which produces higher conversion? better recall? stronger brand equity?) do not exist in published form

---

## Contradictions & Disputes

1. **JTBD school wars**: Ulwick (ODI/quantitative) and Moesta (qualitative/switch interview) have publicly disputed each other's interpretation of JTBD. Christensen's version is different from both. Practitioners must choose a school — mixing them creates methodological confusion.

2. **StoryBrand vs. Dunford**: StoryBrand produces messaging structure but ignores positioning; Dunford produces positioning but doesn't produce copy. Both practitioners have critiqued the other's domain gaps. The right answer is to use both in sequence (Dunford for positioning → StoryBrand for copy architecture).

3. **Features vs. Benefits debate**: FAB practitioners and Means-End theorists agree that benefits matter more than features, but disagree on which benefits. FAB focuses on functional/emotional benefits; Means-End theory suggests terminal values (freedom, security, accomplishment) are the real decision drivers. Both are correct at different altitudes.

4. **Brand platform vs. product marketing**: Apple's "Think Different" era suggests brand platforms drive more durable equity than product marketing. But post-Jobs Apple's success has been driven primarily by product marketing (M-chip benchmarks, camera improvements). This tension is unresolved.
...
- Pages fetched and analyzed: 7
- Most productive search terms: "April Dunford positioning framework 5 components," "Reynolds Gutman 1988 laddering," "Linear app case study marketing," "developer product positioning messaging examples," "Nike Just Do It Wieden Kennedy brand brief"
- Primary information sources: aprildunford.com, Strategyzer/Interaction Design Foundation, academic journals (SAGE, Wiley), Branding Strategy Insider, Eleken case studies, DevPMM Substack

---

## Sources & Evidence

- [FAB Analysis explained — Toolshero](https://www.toolshero.com/marketing/fab-analysis/)
- [Features Advantages Benefits: How to Use the FAB Model in SaaS — Userpilot](https://userpilot.com/blog/features-advantages-benefits/)
- [A Means-End Chain Model Based on Consumer Categorization Processes — Gutman 1982 (SAGE)](https://journals.sagepub.com/doi/10.1177/002224298204600207)
- [Laddering Theory, Method, Analysis, and Interpretation — Reynolds & Gutman 1988](https://is.muni.cz/el/1456/jaro2013/MPH_MVPS/39278324/LadderingTheoy_original.pdf)
- [Connect Values and Benefits with Means-End Chain Framework — Umbrex](https://umbrex.com/resources/frameworks/marketing-frameworks/means-end-chain-laddering-framework/)
- [Value Proposition Canvas — Strategyzer](https://www.strategyzer.com/library/the-value-proposition-canvas)
- [Value Proposition Design Book Summary — Strategyzer](https://www.strategyzer.com/library/value-proposition-design-book-summary)
- [A Quickstart Guide to Positioning — April Dunford](https://www.aprildunford.com/post/a-quickstart-guide-to-positioning)
- [Five Components of Effective Positioning — Heinz Marketing](https://www.heinzmarketing.com/blog/five-components-of-effective-positioning-an-obviously-awesome-book-summary-part-2/)
- [The StoryBrand 7-Part Framework — Gravity Global](https://www.gravityglobal.com/blog/complete-guide-storybrand-framework)
- [StoryBrand Framework Guide — ROI Online](https://www.roionline.com/post/storybrand-7-part-framework-guide-your-brand-story-begins-here)
- [Message House Framework — Umbrex](https://umbrex.com/resources/frameworks/marketing-frameworks/message-house-framework/)
- [How to Build a Brand Message House — Fabrik Brands](https://fabrikbrands.com/branding-matters/verbal-identity/message-house-template/)
- [Benefit Ladder (Attributes–Functional–Emotional–Self-Expressive) — Umbrex](https://umbrex.com/resources/frameworks/marketing-frameworks/benefit-ladder-attributes-functional-emotional-self-expressive/)
...
- [History of JTBD — Strategyn](https://strategyn.com/jobs-to-be-done/history-of-jtbd/)
- [The ultimate guide to JTBD: Bob Moesta (co-creator) — Podpulse](https://podpulse.ai/podcast-notes-and-takeaways/lennys-podcast-product-growth-career-the-ultimate-guide-to-jtbd-bob-moesta-co-creator-of-the-framework)
- [The Deeper Genius of Apple's "1000 Songs in Your Pocket" — Paul Syng](https://paulsyng.com/blog/the-deeper-genius-of-apples-1000-songs-in-your-pocket/)
- [Think Different: Apple's Blue Ocean Formula — Blue Ocean Strategy](https://www.blueoceanstrategy.com/blog/think-different-apple/)
- [The Real Story of Apple's Think Different Campaign — Branding Strategy Insider](https://brandingstrategyinsider.com/the-real-story-of-apples-think-different-campaign/)
- [The Brand Brief Behind Nike's Just Do It Campaign — Branding Strategy Insider](https://brandingstrategyinsider.com/behind-nikes-campaign/)
- [Nike "Just Do It" origin — NPR](https://www.npr.org/2022/10/06/1127032721/nike-just-do-it-slogan-success-dan-wieden-kennedy-dies)
- [Nike Marketing Strategy: Just Do It Campaign — Krows Digital](https://krows-digital.com/nikes-just-do-it-campaign-a-masterclass-in-marketing-excellence/)
- [Developer Product Positioning and Messaging Examples — DevPMM Substack](https://devpmm.substack.com/p/developer-product-positioning-and-messaging-examples-that-slap)
...
- [Open source to PLG: A winning strategy for developer tool companies — Product Marketing Alliance](https://www.productmarketingalliance.com/developer-marketing/open-source-to-plg/)
- [Zero Config Deployments — Vercel](https://vercel.com/blog/zero-config)
- [Challenger Sale — Challenger Inc.](https://www.dckap.com/books/the-challenger-sale/)
- [Crossing the Chasm — Wikipedia](https://en.wikipedia.org/wiki/Crossing_the_Chasm)
- [Mapping the Job-to-be-Done (Job Map) — Tony Ulwick / Medium](https://jobs-to-be-done.com/mapping-the-job-to-be-done-45336427b3bc)
