...
| **One Scheduler for Every Runtime**   | High (concrete) | Anthropic schedules Claude — in its cloud, or locally while the app is open. Pulse schedules Claude Code, Codex, and OpenCode from one place, on your own machine, against your real working directory. (Replaced "The Mac Sleep Problem" on 2026-08-23 — Anthropic fixed that.) | VL-01      |
...
| ~~Cowork scheduling only runs while Mac is awake~~ **RETIRED 2026-08-23** — Anthropic now runs Cowork tasks and Claude Code Routines in its own cloud with your device off. What survives: a cloud run works from files in your Claude account or a fresh GitHub clone, never your working copy (a Cowork cloud task "can't be tied to a folder on your computer"), and **every** path that does reach your disk — a Cowork task needing local files, a cloud session on a connected folder, a Claude Code Desktop local task — still needs the app open and the computer awake. | [support.claude.com/13854387](https://support.claude.com/en/articles/13854387-schedule-recurring-tasks-in-claude-cowork), [code.claude.com/docs/en/routines](https://code.claude.com/docs/en/routines), [code.claude.com/docs/en/desktop-scheduled-tasks](https://code.claude.com/docs/en/desktop-scheduled-tasks) | VL-01, Proof Anchor         |
