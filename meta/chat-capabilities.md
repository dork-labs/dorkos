...
| A-06 | Agents use reactions well: ✅/👀/👍 instead of a "got it" message; agents **see** reactions on their own posts (built: `room-context.ts` acknowledgments) and can **add** them                                      | partial (seeing built; **adding explicitly refused** by `requirePersonAuthor`, etiquette E16b — a policy to reverse, not a gap)                                             | U (seeing) |
...
| A-13 | Catch-up: an agent (or the human) can ask "what did I miss?" and get an honest summary of the channel since a point in time                                                                                         | not built                                                                                                                                                                   | —          |
