...
| A-06 | Agents use reactions well: ✅/👀/👍 instead of a "got it" message; agents **see** reactions on their own posts (built: `room-context.ts` acknowledgments) and can **add** them                                      | **built** (#1015): agents can react, 20/agent/room/hour, additions-only spend; E16b reversed by ADR `260814-195522`; reactions still never cascade                                                                                                                              | U        |
...
| A-13 | Catch-up: an agent (or the human) can ask "what did I miss?" and get an honest summary of the channel since a point in time                                                                                         | partial (#1015: `read_room_history` + `search_room_history` with join-seq floor give the mechanism; summary quality untested)                                                                                                                                                   | —        |
