...
One report per harness is kept here, replaced when it is regenerated. They are dated and name the binary version they were measured against, so a report older than the binary is a report to re-run rather than to trust.
