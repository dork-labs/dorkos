...
**Review** rather than archived, so those inbound links keep resolving. Moving
...
`Active` = live roadmap or unfinished work. `Review` = appears complete but is
still referenced as provenance by shipped specs, so it stays pending a deliberate
reference migration. `Archived` = completed or superseded and moved to
`plans/archive/`.
...
| `2026-02-24-relay-design.md`                                                                                     | Review   | 2026-02-24 | Relay design of record; cited by ~9 implemented relay specs as provenance. Migrate refs before archiving |
| `2026-02-24-mesh-design.md`                                                                                      | Review   | 2026-02-24 | Mesh design doc; superseded by implemented mesh specs but still linked. Migrate refs before archiving    |
| `2026-02-24-litepaper-review.md`                                                                                 | Review   | 2026-02-24 | Litepaper review; open OQs cited by relay specs. Actionable items resolved, vision OQs remain            |
| `2026-02-27-relay-conversation-view-design.md`                                                                   | Review   | 2026-02-27 | Relay conversation-view design; shipped, but paired plan links to it                                     |
| `2026-02-27-relay-conversation-view-plan.md`                                                                     | Review   | 2026-02-27 | Implementation plan for the above; shipped (ConversationRow exists)                                      |
| `2026-02-28-telegram-adapter-investigation.md`                                                                   | Review   | 2026-02-28 | Telegram adapter fixes shipped; cited by implemented `adapter-agent-routing` spec                        |
| `2026-03-05-chat-self-test-findings.md`                                                                          | Review   | 2026-03-05 | Findings report; consumed by implemented `chat-streaming-session-reliability` spec                       |
| `2026-03-06-chat-self-test-findings.md`                                                                          | Review   | 2026-03-06 | Findings report; cited by implemented relay-SSE fix specs                                                |
| `2026-03-06-chat-self-test-findings-2.md`                                                                        | Review   | 2026-03-06 | Findings report (run 2); cited by implemented relay-SSE fix specs                                        |
| `2026-03-06-claude-code-adapter-audit.md`                                                                        | Review   | 2026-03-06 | Adapter-coupling audit; cited by implemented `codex-runtime-adapter-prework` spec                        |
| `mesh-specs/`                                                                                                    | Review   | 2026-04-10 | Pre-`specs/` mesh planning docs; superseded by implemented mesh specs that link back to them             |
| `relay-specs/`                                                                                                   | Review   | 2026-04-10 | Pre-`specs/` relay planning docs; superseded by implemented relay specs that link back to them           |
