 ...
 * multi-window check's runtime comparison, and `playwright.config.ts` itself
 * (`__tests__/`, DOR-1243). The Playwright browser suite runs separately via
 * `pnpm --filter @dorkos/e2e e2e`.
 */
