...
export const features: Feature[] = [
  ...
  // === CORE ===
  {
    ...
    product: 'core',
    category: 'integration',
    tagline: 'Open DorkOS tools to any tool that speaks MCP',
    description:
      'DorkOS opens its tools to any agent that speaks MCP (the standard that lets AI tools talk to each other), including Claude Code, Cursor, and Windsurf.',
    status: 'ga',
    benefits: [
      'Works over a single web connection, nothing to keep open',
      'Optional password protection',
      'Every Tasks, Relay, and Mesh tool, available to any MCP tool',
