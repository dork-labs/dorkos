  ...
  return (
    <>
      <div className="mx-auto max-w-6xl px-6 pt-32 pb-16">
        ...
        {/* Hero media — loop where one exists, still otherwise */}
        {feature.media && (
        ...
        <div className="max-w-3xl">
          ...
          {/* A concrete moment — what actually happens for the user */}
          {feature.moment && (
            <p className="border-brand-orange/40 text-warm-gray mt-8 border-l-2 pl-5 text-lg leading-relaxed">
              {feature.moment}
            </p>
          )}
