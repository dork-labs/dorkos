 ...
 *
 * The two catalogue sections are the published home page's, imported and
 * rendered unmodified. They are good, they are already tested, and the words
 * in them are already settled — reimplementing either one here would fork the
 * feature list and the FAQ into two copies that drift. Each gets a wrapper
