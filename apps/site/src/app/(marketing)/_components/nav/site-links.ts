 ...
 *
 * Derived from the shared {@link NAV_LINKS} rather than typed out again: a
 * destination added to the site menu has to appear here too, and a hand-copied
 * list is a list that silently goes stale. Two edits are applied on the way
 * through.
 *
