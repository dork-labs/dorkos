...
import { BEAT_BOUNDARIES, BEAT_ORDER, beatProgressAt, nextBeat } from '../stage/beats';
import { bandProgressAt, steadyBandIndex } from '../stage/stage-bands';

const THIRDS = [1 / 3, 2 / 3];
const STAGE = readFileSync(join(import.meta.dirname, '..', 'stage', 'StageSection.tsx'), 'utf8');
