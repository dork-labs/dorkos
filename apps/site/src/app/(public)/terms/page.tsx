    ...
    <div className="container-narrow py-12">
      <article className="space-y-8">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">The software is yours to use</h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">You run the agents, so you own what they do</h2>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">The website and services are provided as-is</h2>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">Using the site fairly</h2>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">When these terms change</h2>
          <p className="text-muted-foreground leading-relaxed">
