 ...
 *
 * `id` is a random UUID generated by the audit service and preserved through
 * Better Auth's database adapter. Supplying it explicitly keeps the adapter's
 * default non-UUID string ids out of this PostgreSQL UUID column while the same
 * write path continues to serve production Postgres and in-memory tests.
 * Chronology comes from `createdAt`, not the id.
 */
export const auditLog = pgTable(
  'audit_log',
  {
    /** Random UUID primary key generated by the audit service. */
