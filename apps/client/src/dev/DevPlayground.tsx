            ...
            <SidebarHeader className="border-b p-3">
              <div className="flex items-center gap-2 py-1">
                <SidebarMenuButton
                  ...
                  onClick={() => {
                    // Deliberately a document load, not the link seam: the
                    // playground mounts outside the router (see `Root` in
            ...
            <header className="flex h-9 shrink-0 items-center gap-2 border-b px-2">
              ...
              <div className="ml-auto flex items-center">
                ...
                >
                  ...
                  Search
                  <kbd className="bg-muted rounded px-1 py-0.5 font-mono text-3xs">
                    {MOD_KEY}K
                  </kbd>
                </Button>
              </div>
