...
export const DEGRADED: StatusScenario = {
  label: 'Degraded — live stream lost, context critical, bypass permissions, non-default runtime',
  ctx: {
    cwd: CWD,
...
export const RATE_LIMITED: StatusScenario = {
  label: 'Rate limited — live stream lost, context critical, subscription exhausted',
  ctx: {
    ...DEGRADED.ctx,
    permissionMode: 'default',
    permissionDescriptor: null,
