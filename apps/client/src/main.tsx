    ...
    >
      ...
      <div className="flex h-8 shrink-0 items-center gap-0.5 border-b border-white/10 bg-[#181825] px-1">
        <button
          ...
          className={`cursor-default rounded px-2.5 py-0.5 text-2xs font-medium transition-colors ${
        ...
        <div className="ml-auto flex items-center gap-0.5">
          <button
            ...
            className="cursor-default rounded p-1 text-3xs leading-none text-white/40 transition-colors hover:bg-white/10 hover:text-white"
