      ...
      {MOBILE_TABS.map((tab) => {
        ...
        return (
          <button
            ...
            data-mobile-tab=""
            className={cn(
              'focus-ring text-2xs relative flex flex-1 flex-col items-center justify-center gap-0.5 transition-[color,background-color,scale] duration-150',
            ...
            <span className="relative">
              ...
              {badge !== null && (
                <span
                  ...
                  // not one.
                  className="text-3xs absolute -top-1.5 -right-2.5 min-w-4 rounded-full bg-amber-500 px-1 text-center leading-4 font-semibold text-amber-950 tabular-nums"
                >
                  {badge}
                </span>
              )}
