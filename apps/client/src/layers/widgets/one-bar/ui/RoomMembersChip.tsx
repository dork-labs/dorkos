...
import { openRoomPanel, type RoomDetailsRoom } from '@/layers/features/room-management';
 ...
 *
 * **It opens the room panel** (phase R2, spec §3.6) — the right panel's Room
 * tab, focused on the roster. The chip names what the reader wanted
 * (`'members'`) rather than which surface answers it, which is why re-pointing
 * it from the old modal to the panel was this one line.
 *
 * The panel resolves the room from the route itself, so nothing about which room
 * this is has to travel with the press.
 */
