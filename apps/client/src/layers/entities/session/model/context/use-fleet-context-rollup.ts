 ...
 * later.
 *
 * @module entities/session/model/context/use-fleet-context-rollup
 */
import { useCallback, useMemo } from 'react';
import { useQueries, type UseQueryResult } from '@tanstack/react-query';
import type { ModelOption } from '@dorkos/shared/types';
import { useTransport } from '@/layers/shared/model';
import { modelsQueryOptions } from '../query/use-models';
import { useSessionListSessions, useSessionListStore } from '../stream/session-list-store';
