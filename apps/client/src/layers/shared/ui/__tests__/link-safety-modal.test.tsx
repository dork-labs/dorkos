...
describe('LinkSafetyModal — a link the seam refuses (DOR-547)', () => {
  it('says so in place, and makes copy the primary action', () => {
    ...
    // The dialog's accessible name is now its `DialogTitle` — the same
    // sentence the body shows — rather than the hand-rolled "Link cannot be
    // opened" `aria-label` the portal version carried.
