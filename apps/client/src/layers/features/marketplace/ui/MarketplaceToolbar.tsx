...
function MarketplaceSearchInput() {
  ...
  return (
    <div className="group/search relative">
      ...
      <kbd className="text-muted-foreground/60 pointer-events-none absolute top-1/2 right-3 -translate-y-1/2 rounded border border-current/20 px-1.5 py-0.5 font-mono text-3xs leading-none group-focus-within/search:opacity-0">
        /
      </kbd>
    </div>
  );
