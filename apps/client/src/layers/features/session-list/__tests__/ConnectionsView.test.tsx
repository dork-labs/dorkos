...
describe('ConnectionsView', () => {
  ...
  it('renders Adapters section with adapter names and status', () => {
    ...
    render(<ConnectionsView toolStatus={enabledToolStatus} projectPath="/test" />, { wrapper: Wrapper });
  ...
  it('hides Adapters section when Relay is disabled-by-server', () => {
    ...
    render(<ConnectionsView toolStatus={toolStatus} projectPath="/test" />, { wrapper: Wrapper });
  ...
  it('accepts null projectPath', () => {
    render(<ConnectionsView toolStatus={enabledToolStatus} projectPath={null} />, { wrapper: Wrapper });
    expect(screen.getByText('Adapters')).toBeInTheDocument();
    expect(screen.getByText('Agents')).toBeInTheDocument();
  });
