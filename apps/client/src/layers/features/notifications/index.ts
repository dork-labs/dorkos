 ...
 *
 * The barrel is narrow on purpose — the mounted components, and the cue player
 * the session view uses for its turn-finished chime. The arrival watcher, the
 * primer latch and the push-subscription flow are how those are built rather
 * than what a consumer needs, and this slice's own tests import them by path.
