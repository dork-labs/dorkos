/**
 * The empty chat session's message: the three mutually-exclusive things a
 ...
 *   3. Otherwise → the generic invitation to start typing.
 *
 * Purely presentational: the caller owns the store reads and derives the inputs,
 * so this component is a dumb switch over already-resolved state.
 *
 ...
 *
 * @param props - The resolved empty-state inputs (see {@link ChatEmptyStateProps}).
 */
export function ChatEmptyState({ birthRecord, firstLightRecord }: ChatEmptyStateProps) {
