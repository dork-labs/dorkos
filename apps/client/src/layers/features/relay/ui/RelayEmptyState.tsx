...
interface RelayEmptyStateProps {
  /** Called when the user clicks the keystone "Add Connection" action. */
  onAddConnection: () => void;
}

/** Full-bleed ghost preview empty state for Relay Mode A (no connections configured). */
export function RelayEmptyState({ onAddConnection }: RelayEmptyStateProps) {
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-6 py-16">
      ...
      <p className="text-muted-foreground mb-6 max-w-sm text-center text-sm">
        Add your first connection to start sending and receiving messages.
      </p>
