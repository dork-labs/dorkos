...
| Sign-in methods      | `GET /api/v1/account/sign-in-methods`; `POST /api/v1/account/password`                                                                  | See how the account signs in; add a first password within 5 minutes of sign-in |
