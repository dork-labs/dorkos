 ...
 * bucket". It would, and that is the right trade for a single-operator system:
 * one shared 60/minute bucket for tunnel traffic costs the operator nothing and
 * costs an attacker the unlimited-buckets trick. Per-client buckets behind a
